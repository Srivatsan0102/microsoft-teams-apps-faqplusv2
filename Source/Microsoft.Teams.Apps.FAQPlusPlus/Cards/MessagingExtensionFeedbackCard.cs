// <copyright file="MessagingExtensionFeedbackCard.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.FAQPlusPlus.Cards
{
    ...
    /// <summary>
    /// Implements messaging extension feedback tickets card.
    /// </summary>
    public class MessagingExtensionFeedbackCard : FeedbackTicketCard
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessagingExtensionFeedbackCard"/> class.
        /// </summary>
        /// <param name="ticket">The feedback ticket model with the latest details.</param>
        public MessagingExtensionFeedbackCard(FeedbackTicketEntity ticket)
            : base(ticket)
        {
        }
        ...
        /// <summary>
        /// Returns go to original thread uri which will help in opening the original conversation about the feedback ticket.
        /// </summary>
